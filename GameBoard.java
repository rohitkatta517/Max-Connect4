...
public class GameBoard {
        ...
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 4; j++) {
                if (((this.playBoard[i][j] == player) &&
                        (this.playBoard[i][j + 1] == player) &&
                        (this.playBoard[i][j + 2] == player) &&
                        (this.playBoard[i][j + 3] == 0)) ||
                        ((this.playBoard[i][j] == 0) &&
                                (this.playBoard[i][j + 1] == player) &&
                                (this.playBoard[i][j + 2] == player) &&
                                (this.playBoard[i][j + 3] == player)) ||
                        ((this.playBoard[i][j] == player) &&
                                (this.playBoard[i][j + 1] == 0) &&
                                (this.playBoard[i][j + 2] == player) &&
                                (this.playBoard[i][j + 3] == player)) ||
                        ((this.playBoard[i][j] == player) &&
                                (this.playBoard[i][j + 1] == player) &&
                                (this.playBoard[i][j + 2] == 0) &&
                                (this.playBoard[i][j + 3] == player))
                        ) {
                    playerScore++;
                }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                if ((this.playBoard[i][j] == player) &&
                        (this.playBoard[i + 1][j + 1] == player) &&
                        (this.playBoard[i + 2][j + 2] == player) &&
                        (this.playBoard[i + 3][j + 3] == 0) ||
                        ((this.playBoard[i][j] == player) &&
                                (this.playBoard[i + 1][j + 1] == 0) &&
                                (this.playBoard[i + 2][j + 2] == player) &&
                                (this.playBoard[i + 3][j + 3] == player)) ||
                        ((this.playBoard[i][j] == 0) &&
                                (this.playBoard[i + 1][j + 1] == player) &&
            ...
            for (int j = 0; j < 4; j++) {
                if (((this.playBoard[i + 3][j] == 0) &&
                        ...
                        ((this.playBoard[i + 3][j] == player) &&
                                ...
                                (this.playBoard[i][j + 3] == 0)) ||
                        ((this.playBoard[i + 3][j] == player) &&
                                (this.playBoard[i + 2][j + 1] == 0) &&
                                (this.playBoard[i + 1][j + 2] == player) &&
                                (this.playBoard[i][j + 3] == player)) ||
                        ((this.playBoard[i + 3][j] == player) &&
                                (this.playBoard[i + 2][j + 1] == player) &&
                                (this.playBoard[i + 1][j + 2] == 0) &&
                                (this.playBoard[i][j + 3] == player))) {
                    playerScore++;
                }
            }
    ...
    public int getTwoCount(int player) {
        ...
        for (int i = 0; i < 6; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if(this.playBoard[i][j] == player) {
                    sum++;
                } else if(this.playBoard[i][j] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i][j+1] == player) {
                    sum++;
                } else if(this.playBoard[i][j+1] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i][j+2] == player) {
                    sum++;
                } else if(this.playBoard[i][j+2] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i][j+3] == player) {
                    sum++;
                } else if(this.playBoard[i][j+3] == 0) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if(this.playBoard[i+1][j+1] == player) {
                    sum++;
                } else if(this.playBoard[i+1][j+1] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i+2][j+2] == player) {
                    sum++;
                } else if(this.playBoard[i+2][j+2] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i+3][j+3] == player) {
                    sum++;
                } else if(this.playBoard[i+3][j+3] == 0) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                ...
                if(this.playBoard[i+3][j] == player) {
                    sum++;
                } else if(this.playBoard[i+3][j] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i+2][j+1] == player) {
                    sum++;
                } else if(this.playBoard[i+2][j+1] == 0) {

                } else {
                    sum--;
                }
                if(this.playBoard[i+1][j+2] == player) {
                    sum++;
                } else if(this.playBoard[i+1][j+2] == 0) {
    ...
    /**
     * the method is to check if board is full
     *
     * @return an bool value representing whose turn it is full or not.
     */
    public boolean isFull() {
        return (this.pieceCount > 41);
    } // end getCurrentTurn
